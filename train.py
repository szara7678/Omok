        ...
        for j in range(board_size):
            if board.board[i][j] != 0:
                ...
                for di, dj in [(0, 1), (1, 0), (1, 1), (1, -1)]:
                    ...
                    for k in range(5):
                        ni, nj = i + k * di, j + k * dj
                        if 0 <= ni < board_size and 0 <= nj < board_size and board.board[ni][nj] == board.board[i][j]:
                            count += 1
                    if count == 5:
...
# 모델 훈련
train_model(model1, model2, epochs=10, games_per_epoch=100)
...
# 총 승률 저장
total_win_rate_model1 = total_wins_model1 / (5 * 2)
